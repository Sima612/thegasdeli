        ...
        <div className="flex flex-wrap mt-6 justify-between mb-10 w-full">
          ...
          <section className="px-3 grid w-1/2">
            ...
            <section className="px-3 text-xl font-medium text-slate-800 pt-6">
              Product Description:
              <div className="pt-5">
                <p>SKYWALKER OG | STIIIZY</p>
                <p className="pt-4">THC Pod - STIIIZY Battery Required</p>
                <p className="pt-4">Taste: Earthy, Pungent, Pine</p>
                <p>Feeling: Relaxing, Happy, Sleepy</p>
                <p className="pt-4">
                  A cross between Skywalker and OG Kush. Skywalker OG is a super
                  potent strain that makes relaxation a top priority.
                </p>
                <p className="pt-4">

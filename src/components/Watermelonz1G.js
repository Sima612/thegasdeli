        ...
        <div className="flex flex-wrap mt-6 justify-between mb-10 w-full">
          ...
          <section className="px-3 grid w-1/2">
            ...
            <section className="px-3 text-xl font-medium text-slate-800 pt-6">
              Product Description:
              <div className="pt-5">
                <p>WATERMELON Z | STIIIZY</p>
                <p className="pt-4">THC Pod - STIIIZY Battery Required</p>
                <p className="pt-4">Taste: Berry, Citrus, Sweet</p>
                <p>Feeling: Euphoric, Relaxed, Uplifting</p>
                <p className="pt-4">
                  This mouthwatering strain is perfect for lazy nights on the
                  couch.
                </p>
                <p className="pt-4">
